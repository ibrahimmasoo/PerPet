...
Near me system added:
- List a Pet now includes city, area, and optional live location (lat/lng)
- Find a Pet now includes:
  - Near me button
  - Radius filter
  - Sort by closest
  - City fallback filter
- Pets save city/area/lat/lng locally and to Firestore when available

For public nearest search from Firestore, pets collection read must be allowed.
